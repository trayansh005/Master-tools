          ...
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            ...
            <div className="order-3 xl:order-2">
              <h4 className="mb-2 text-lg font-semibold text-center text-gray-800 dark:text-white/90 xl:text-left">
                {user?.name ? user.name.toUpperCase() : "RANDOM USER"}
              </h4>
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <Input type="text" defaultValue={user?.first_name || "First Name"} />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Last Name</Label>
                    <Input type="text" defaultValue={user?.last_name || "Last Name"} />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Email Address</Label>
                    <Input type="text" defaultValue={user?.email || "Email"} />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Phone</Label>
                    <Input type="text" defaultValue={user?.phone || "Phone"} />
                  </div>

                  <div className="col-span-2">
                    <Label>Bio</Label>
                    <Input type="text" defaultValue={user?.bio || "Bio"} />
                  </div>
                </div>
              </div>
            </div>
